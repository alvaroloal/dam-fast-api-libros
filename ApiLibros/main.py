...
from controller.libro_controller import router as libro_router
...
app = FastAPI(
    title="API Libros",
    description="Api CRUD básico para gestionar libros de una biblioteca.",
    version="1.0.0",
...
fake_users_db = {
    "alvaro": {
        "username": "alvaro",
        "full_name": "Álvaro Lorente Almán",
